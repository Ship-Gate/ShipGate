...
// src/features/import-resolver.ts
...
// src/features/semantic-linter.ts
import { DiagnosticSeverity as DiagnosticSeverity2 } from "@isl-lang/lsp-core";
var LINT_RULES = {
  // Correctness rules
  "ISL1001": {
    id: "ISL1001",
  ...
  "ISL1002": {
    ...
    severity: DiagnosticSeverity2.Hint,
    category: "correctness"
  },
  "ISL1003": {
    id: "ISL1003",
...
import { TextEdit as TextEdit2 } from "vscode-languageserver";
...
// src/features/scanner-diagnostics.ts
import { DiagnosticSeverity as DiagnosticSeverity3 } from "vscode-languageserver";
...
function tierToLSPSeverity(tier) {
  switch (tier) {
    case "hard_block":
      return DiagnosticSeverity3.Error;
    case "soft_block":
      return DiagnosticSeverity3.Warning;
    case "warn":
      return DiagnosticSeverity3.Information;
    default:
      return DiagnosticSeverity3.Warning;
  }
}
...
// src/server.ts
import { DiagnosticSeverity as DiagnosticSeverity4 } from "@isl-lang/lsp-core";
var ISLServer = class {
  connection;
  documents;
  documentManager;
  ...
  setupHandlers() {
          ...
          for (const fix of data.quickFixes) {
            actions.push({
              ...
              edit: {
                changes: {
                  [document.uri]: [
                    TextEdit3.replace(diag.range, fix.edit)
                  ]
                }
              }
            });
    ...
    this.connection.onRequest("isl/validate", (params) => {
      ...
      const errors = diagnostics.filter((d) => d.severity === DiagnosticSeverity4.Error).map((d) => d.message);
