...
export type ISLSymbolKind = 'domain' | 'entity' | 'behavior' | 'type' | 'invariant' | 'policy' | 'view' | 'scenario' | 'field' | 'input' | 'output' | 'error' | 'state' | 'constraint';
...
export type SemanticTokenType = 'namespace' | 'type' | 'class' | 'enum' | 'interface' | 'struct' | 'typeParameter' | 'parameter' | 'variable' | 'property' | 'enumMember' | 'function' | 'method' | 'keyword' | 'modifier' | 'comment' | 'string' | 'number' | 'regexp' | 'operator' | 'decorator';
