...
var firewall = require('@isl-lang/firewall');
...
var ISLDocumentManager = class {
  ...
  debounceMs = 150;
  constructor() {
    this.parser = new lspCore.IncrementalParser();
    this.symbolIndex = new lspCore.SymbolIndex();
  }
  /**
...
var ISLImportResolver = class {
  ...
  async resolveImport(documentUri, importStmt) {
    ...
    if (!importedDomain) {
      diagnostics.push({
        ...
        severity: lspCore.DiagnosticSeverity.Error,
  ...
  resolveImportPath(documentUri, importPath) {
    if (importPath.startsWith("./") || importPath.startsWith("../")) {
      const documentPath = vscodeUri.URI.parse(documentUri).fsPath;
      const documentDir = path__namespace.dirname(documentPath);
      const resolved = path__namespace.resolve(documentDir, importPath);
      const withExtension2 = resolved.endsWith(".isl") ? resolved : `${resolved}.isl`;
      return vscodeUri.URI.file(withExtension2).toString();
    }
    const withExtension = importPath.endsWith(".isl") ? importPath : `${importPath}.isl`;
    return vscodeUri.URI.file(withExtension).toString();
  }
  /**
  ...
  async loadDomain(uri) {
    ...
    try {
      ...
      const result = parse(content, vscodeUri.URI.parse(uri).fsPath);
  ...
  async defaultFileProvider(uri) {
    try {
      ...
      const filePath = vscodeUri.URI.parse(uri).fsPath;
...
var LINT_RULES = {
  ...
  "ISL1001": {
    ...
    severity: lspCore.DiagnosticSeverity.Warning,
  ...
  "ISL1002": {
    ...
    severity: lspCore.DiagnosticSeverity.Hint,
    category: "correctness"
  },
  "ISL1003": {
    id: "ISL1003",
      ...
      if (!usedImports.has(name)) {
        ...
        if (importLocation) {
          diagnostics.push({
            ...
            severity: vscodeLanguageserver.DiagnosticSeverity.Hint,
            code: "ISL2003",
            source: "isl-import-resolver",
            data: {
              type: "unused-import",
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, typeDefinition)
          ]
        }
      }
    };
  ...
  createRenameToUppercaseAction(document, range, name) {
    ...
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [vscodeLanguageserver.TextEdit.replace(range, newName)]
        }
      }
    };
  }
...
`;
    return {
      ...
      kind: vscodeLanguageserver.CodeActionKind.Refactor,
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, scenarioBlock)
          ]
        }
      }
    };
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, crudBehaviors)
          ]
        }
      }
    };
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, errorBlock)
          ]
        }
      }
    };
  ...
  createRemoveUnusedTypeAction(document, range, typeName) {
    ...
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.del({
  ...
  createRenameToBehaviorAction(document, range, currentName, targetName) {
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [vscodeLanguageserver.TextEdit.replace(range, targetName)]
        }
      }
    };
  }
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, temporalBlock)
          ]
        }
      }
    };
  ...
  createAddConstraintsAction(document, range, fieldName, suggestedConstraints) {
    ...
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.replace(
              {
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, securityBlock)
          ]
        }
      }
    };
...
`;
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.insert({ line: insertLine, character: 0 }, paginationFields)
          ]
        }
      }
    };
  ...
  createRemoveImportAction(document, range, symbolName) {
    ...
    return {
      ...
      edit: {
        changes: {
          [document.uri]: [
            vscodeLanguageserver.TextEdit.replace(range, "")
          ]
        }
      }
    };
...
var ScannerDiagnosticsProvider = class {
  ...
  constructor(options = {}) {
    ...
    this.firewallInstance = firewall.createIntegratedFirewall({
...
var ISLServer = class {
  ...
  setupHandlers() {
    ...
    this.connection.onRequest("isl/validate", (params) => {
      ...
      const errors = diagnostics.filter((d) => d.severity === lspCore.DiagnosticSeverity.Error).map((d) => d.message);
...
Object.defineProperty(exports, "DiagnosticSeverity", {
  enumerable: true,
  get: function () { return lspCore.DiagnosticSeverity; }
});
exports.ISLCodeActionProvider = ISLCodeActionProvider;
...
exports.ISLImportResolver = ISLImportResolver;
exports.ISLSemanticLinter = ISLSemanticLinter;
...
exports.LINT_RULES = LINT_RULES;
exports.SOURCE_HOST = SOURCE_HOST;
exports.SOURCE_REALITY_GAP = SOURCE_REALITY_GAP;
exports.ScannerDiagnosticsProvider = ScannerDiagnosticsProvider;
exports.TOKEN_MODIFIERS = TOKEN_MODIFIERS;
