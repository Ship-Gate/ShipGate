...
- Initial release
- Recursive descent parser for ISL syntax
- Support for domains, intents, types, and contracts
- Tokenizer with full ISL grammar support
- Source location tracking for error messages
- AST node types and visitor pattern
