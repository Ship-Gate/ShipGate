/**
 * Go standard library package check (minimal set for firewall evidence resolution).
 * Full list lives in @isl-lang/hallucination-scanner/go/stdlib.
 *
 * @module @isl-lang/firewall/go
 */

const GO_STDLIB: ReadonlySet<string> = new Set([
