 ...
 * @isl-lang/stdlib-core/validation
 */
...
// ============================================================================
// ASYNC VALIDATOR (for future use)
// ============================================================================

export type AsyncValidator<T> = (value: unknown) => Promise<ValidationResult & { value?: T }>;

export async function validateAsync<T>(
  validator: AsyncValidator<T>,
  value: unknown
): Promise<ValidationResult & { value?: T }> {
  return validator(value);
}
