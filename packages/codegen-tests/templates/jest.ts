 ...
 */
export function getJestTemplate(): JestTemplate {
  return {
    header: `
/**
 ...
 */
export function getJestSetup(): string {
  return `
/**
 * Jest setup file
 * @generated
 ...
 */
export function generateJestDescribe(
  name: string,
  content: string,
 ...
 */
export function generateJestIt(
  name: string,
  content: string,
  options: { async?: boolean; skip?: boolean; only?: boolean; timeout?: number } = {}
): string {
  const modifier = options.skip ? '.skip' : options.only ? '.only' : '';
 ...
 */
export function generateJestBeforeEach(content: string, options: { async?: boolean } = {}): string {
  const asyncKeyword = options.async ? 'async ' : '';
  return `
 ...
 */
export function generateJestAfterEach(content: string, options: { async?: boolean } = {}): string {
  const asyncKeyword = options.async ? 'async ' : '';
  return `
 ...
 */
export function generateJestMock(target: string, implementation?: string): string {
  if (implementation) {
 ...
 * Generate a Jest spy
 */
export function generateJestSpy(object: string, method: string): string {
 ...
 */
export function generateJestExpect(
  value: string,
  matcher: string,
  expected?: string
): string {
