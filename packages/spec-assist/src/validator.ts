...
async function runQuickVerify(isl: string): Promise<VerifyStageResult> {
  try {
    ...
    // Verifier not available — report as unsuccessful rather than silently passing
