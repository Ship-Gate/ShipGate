...
export type { AggregatedCompliance, FrameworkScore, CrossFrameworkGap } from './aggregator';

// Auto-linking
export { VerificationAutoLinker, autoLinkVerification } from './auto-linker';
export type { LinkedControl, VerificationLink, AutoLinkResult } from './auto-linker';
