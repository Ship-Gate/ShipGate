...
/** Strict defaults: all guardrails enforced */
...
/**
 * Result of applying guardrails to a decision.
 */
export interface GuardrailResult {
  /** Additional reasons injected by guardrails */
  reasons: VerdictReason[];
  /** Whether guardrails forced a verdict cap (e.g. WARN-at-best) */
  verdictCap: 'SHIP' | 'WARN' | 'NO_SHIP' | null;
  /** Score penalty applied (subtracted from overall score) */
  scorePenalty: number;
  /** Risk acceptances for overridden guardrails */
  riskAcceptances: RiskAcceptance[];
  /** Human-readable warnings to display in output */
  warnings: string[];
}
...
export interface AuthoritativeGateResult {
  ...
  verifiedIntent?: import('../verified-intent/types.js').VerifiedIntentResult;
...
export interface AuthoritativeGateInput {
   ...
   */
  verifiedIntent?: import('../verified-intent/types.js').VerifiedIntentConfig | false;
