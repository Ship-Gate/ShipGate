...
/** Unique marker to identify Shipgate ISL comments for updates */
const COMMENT_MARKER = '<!-- SHIPGATE_ISL_REPORT -->';

/** Default options for comment generation */
const DEFAULT_OPTIONS: CommentOptions = {
  maxFailedClauses: 5,
  includeFullReport: true,
  footerText: '*This comment is automatically generated by Shipgate ISL verification.*',
};
...
/**
 * Find existing Shipgate ISL comment by marker
 */
...
Example:
  GITHUB_TOKEN=ghp_xxx GITHUB_REPOSITORY=owner/repo GITHUB_PR_NUMBER=123 \\
    npx tsx scripts/github/commentEvidence.ts .shipgate/reports/evidence.json
`);
